...
function Messages({ chatsData, user, width }) {
  ...
  useEffect(() => {
    ...
    socket.current.off("messagesLoaded");
    socket.current.off("noChatFound");
  ...
  return (
    <>
      ...
      <div
        className={`containerBox ${classes.messagesWrapper}`}
        style={{ padding: "0" }}
      >
        <Segment style={{ minWidth: "70vw" }} padded basic size="large">
          {/* <Header
          icon="home"
          content="Go Back!"
          onClick={() => router.push("/")}
              ...
              <Grid stackable>
                ...
                >
                  <Comment.Group size="big">
                    <div className="boxShadowGentle">
                      <Segment
                        raised
                        style={{ overflow: "auto", maxHeight: "32rem" }}
                      >
                        {chats.map((chat, i) => (
                          <div key={chat.date.toString()}>
                            <Chat
                              chat={chat}
                    ...
                    <>
                      <div
                        ...
                        style={{
                          overflow: "auto",
                          // boxShadow:
                          //   "0 9px 0px 0px white, 0 -9px 3px 0px white, 5px 0 5px -4px #aaaaaa, -5px 0 5px -4px #aaaaaa",
                          // padding: 0,
                          // margin: 0,
                          // paddingLeft: "0.5rem",
                          overflowX: "hidden",
                          maxHeight: "30rem",
                          height: "30rem",
                          backgroundColor: "rgba(76,127,137,0.13)",
                        }}
                      >
                        <div
                          style={{
                      ...
                      <MessageInputField width={width} sendMsg={sendMsg} />
                    </>
                  )}
                </Grid.Column>
              </Grid>
